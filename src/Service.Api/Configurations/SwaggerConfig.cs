    ...
    public static class SwaggerConfig
    {
        public static void AddSwaggerConfiguration(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                ...
                {
                    Version = "v1",
                    Title = "DNA Developers Ecommerce Project",
                    Description = " API Swagger surface",
                    Contact = new OpenApiContact { Name = "José Paulo Galdino", Email = "dnadevelopersoftware@gmail.com", Url = new Uri("http://www.gmail.com") },
